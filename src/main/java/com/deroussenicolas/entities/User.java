...
public class User implements Serializable {
	...
	public String toString() {
		return "User [id_user= AutoGenerated, firstname=" + firstname + ", lastname=" + lastname + ", email=" + email
				+ ", password=" + password + ", roles=" + roles + ", topicList=" + topicList + ", postList=" + postList
